...
class PostgresConnection {
    ...
    init(configuration: DatabaseConnectionConfiguration) async throws {
        ...
        if let sshConfig = configuration.sshTunnel, sshConfig.enabled {
            print("🔌 PostgresConnection: SSH tunnel enabled, establishing tunnel...")
            ...
            print("✅ PostgresConnection: SSH tunnel established on localhost:\(connectionPort)")
        } else {
            // Direct connection without SSH tunnel
            print("🔌 PostgresConnection: Direct connection (no SSH tunnel)")
